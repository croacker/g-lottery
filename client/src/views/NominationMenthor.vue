...
<div class="container">
  ...
  <b-container>
    <b-button-group class="mt-2">
      <b-btn href="/nomination-creative-class">Previous</b-btn>
      <b-btn href="/nomination-certificate">Next</b-btn>
    </b-button-group>
  </b-container>
</div>
</template>
...
export default {
  ...
  created: function () {
    this.$store.dispatch('fetchNomination', 'menthor').then((result) => {
